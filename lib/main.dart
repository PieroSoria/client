...
import 'package:puntos_client/helper/notification_helper.dart';
import 'package:puntos_client/helper/responsive_helper.dart';
import 'package:puntos_client/helper/route_helper.dart';
import 'package:puntos_client/theme/dark_theme.dart';
import 'package:puntos_client/theme/light_theme.dart';
import 'package:puntos_client/util/app_constants.dart';
import 'package:puntos_client/util/messages.dart';
...
import 'package:puntos_client/features/home/widgets/cookies_view.dart';
...
Future<void> main() async {
  ...
  if (GetPlatform.isWeb) {
    ...
    await Firebase.initializeApp(
      options: const FirebaseOptions(
        apiKey: "AIzaSyAd4pHA25AYeXaov9FWEwzMOjcHr0hpcwg",
        appId: "1:976029574964:android:726e74657eea2744582761",
        messagingSenderId: "976029574964",
        projectId: "puntos-smart-nuevo",
      ),
    );
  } else if (GetPlatform.isIOS) {
    await Firebase.initializeApp(
      options: const FirebaseOptions(
        apiKey: "AIzaSyBQR1YbHxCOIPXzowg71b297LwSFvwc3Fs",
        appId: "1:976029574964:ios:d33a418ea0bfcb92582761",
        messagingSenderId: "976029574964",
        projectId: "puntos-smart-nuevo",
      ),
    );
