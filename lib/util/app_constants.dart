...
import 'package:puntos_client/common/models/choose_us_model.dart';
...
class AppConstants {
  static const String appName = 'Puntos Smart';
  ...
  static const String webHostedUrl = 'https://backend.puntossmart.com';
  static const bool useReactWebsite = false;

  static const String baseUrl = 'https://backend.puntossmart.com';
  ...
  static const String registerUri = '/api/v1/auth/sign-up-mod';
  ...
  //survey
  static const String surveyStore =
      '/api/v1/customer/surveys/getSurveyStorelist';
  static const String sendSurvey =
      '/api/v1/customer/surveys/submitSurveyByUser';
