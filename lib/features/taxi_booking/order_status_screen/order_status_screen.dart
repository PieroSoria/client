...
import 'package:puntos_client/common/widgets/cancellation_dialog.dart';
import 'package:puntos_client/common/widgets/custom_app_bar.dart';
import 'package:puntos_client/common/widgets/ripple_button.dart';
                  ...
                  child: Column(
                    children: [
                      Row(
                        ...
                        children: [
                          Text(
                            'Tuesday, 16 Auust 2022, 10.45 am',
                            style: robotoBold.copyWith(
                                fontSize: Dimensions.fontSizeDefault),
                          ),
                          Image.asset(
