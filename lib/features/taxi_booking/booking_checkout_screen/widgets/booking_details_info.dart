...
import 'package:puntos_client/features/taxi_booking/select_map_location/widgets/dotted_line.dart';
import 'package:puntos_client/features/taxi_booking/select_map_location/widgets/pick_and_destination_address_info.dart';
...
class _BookingDetailsInfoState extends State<BookingDetailsInfo> {
            ...
            Container(
              ...
              decoration: BoxDecoration(
                ...
                boxShadow: [
                  BoxShadow(
                    color: Colors.grey[
                        Get.find<ThemeController>().darkTheme ? 800 : 300]!,
                    blurRadius: 5,
                    spreadRadius: 1,
                  )
                ],
              ...
              child: Row(
                children: [
                  CustomImage(
                    width: 48,
                    height: 46,
                    image: widget.vehicle.carImages!.isNotEmpty
                        ? widget.vehicle.carImages![0]
                        : '',
                  ),
                    ...
                    children: [
                      ...
                      Row(
                        children: [
                          ...
                          Text(widget.vehicle.categoryName!,
                      ...
                      children: [
                        ...
                        Column(
                          ...
                          children: [
                            ...
                            Text(
                                widget.filterBody.filterType == 'hourly'
                                    ? 'hourly'.tr
                                    : 'per_km'.tr,
                                style: robotoRegular.copyWith(
                                    fontSize: Dimensions.fontSizeExtraSmall)),
                  ...
                  return Column(
                    children: [
                      Row(
                        ...
                        children: [
                          Text(
                            'have_any_promo_code'.tr,
                            style: robotoBold.copyWith(
                                fontSize: Dimensions.fontSizeDefault),
                          ),
                          InkWell(
                            onTap: () {
                              if (!bookingCheckoutController
                                  .showCouponSection) {
                      ...
                      const SizedBox(height: Dimensions.paddingSizeDefault),
                      bookingCheckoutController.showCouponSection
                          ? Container(
                              decoration: BoxDecoration(
                              ...
                              child: Row(children: [
                                      ...
                                      decoration: InputDecoration(
                                        ...
                                        border: OutlineInputBorder(
                                          borderRadius: BorderRadius.horizontal(
                                            left: Radius.circular(Get.find<
                                                        LocalizationController>()
                                                    .isLtr
                                                ? 10
                                                : 0),
                                            right: Radius.circular(Get.find<
                                                        LocalizationController>()
                                                    .isLtr
                                                ? 0
                                                : 10),
                                ...
                                InkWell(
                                  onTap: () {
                                    String couponCode =
                                        _couponTextController.text.trim();
                    ...
                    Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          billDetailsItem('subtotal'.tr,
                              PriceConverter.convertPrice(subTotalPrice)),
                          const SizedBox(height: Dimensions.paddingSizeSmall),
                          billDetailsItem('vat'.tr,
                              '(+) ${PriceConverter.convertPrice(vatTax)}'),
                          const SizedBox(height: Dimensions.paddingSizeSmall),
                          billDetailsItem('service_fee'.tr,
                              '(+) ${PriceConverter.convertPrice(serviceFee)}'),
                          const SizedBox(height: Dimensions.paddingSizeSmall),
                          billDetailsItem('coupon_discount'.tr,
                              '(-) ${PriceConverter.convertPrice(bookingCheckoutController.couponDiscount)}'),
                          const SizedBox(height: Dimensions.paddingSizeSmall),
                          billDetailsItem('advance_booking_fee'.tr,
                              '(+) ${PriceConverter.convertPrice(30)}',
                              isPrimary: true),
                        ],
                      ),
                    ),
                  ...
                  children: [
                    Row(
                      children: [
                        ...
                        Expanded(
                            child: Text(
                          'advanced_booking_free_should_be_pay'.tr,
                          style: robotoRegular.copyWith(
                              fontSize: Dimensions.fontSizeSmall,
                              color: Theme.of(context)
                                  .textTheme
  ...
  Widget billDetailsItem(String billName, String price,
