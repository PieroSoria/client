...
import 'package:puntos_client/features/taxi_booking/booking_checkout_screen/widgets/custom_header_icon.dart';
import 'package:puntos_client/features/taxi_booking/booking_checkout_screen/widgets/custom_header_line.dart';
import 'package:puntos_client/features/taxi_booking/booking_checkout_screen/widgets/custom_text.dart';
                  ...
                  children: [
                        ...
                        children: [
                          InkWell(
                            ...
                            child: const CustomHeaderIcon(
                              assetIconUnSelected:
                                  Images.bookingDetailsUnselected,
                            ),
                          ),
                          ...
                          InkWell(
                              onTap: () {
                                controller.updateState(PageState.complete,
                                    shouldUpdate: true);
                              },
                              child: const CustomHeaderIcon(
                    ...
                    if (controller.currentPage == PageState.orderDetails &&
                      ...
                      Positioned(
                        ...
                        right:
                            Get.find<LocalizationController>().isLtr ? null : 0,
                        top: 0,
                        bottom: 0,
                    ...
                    if (controller.currentPage == PageState.payment ||
                      ...
                      Positioned(
                        child: Align(
                          ...
                          child: GestureDetector(
                              onTap: () {
                                controller.updateState(PageState.orderDetails,
                                    shouldUpdate: true);
                              },
                              child: Container(
                                height: 55,
                  ...
                  children: [
                    ...
                    Padding(
                      padding: EdgeInsets.only(
                        right:
                            Get.find<LocalizationController>().isLtr ? 25 : 0,
                        left:
                            Get.find<LocalizationController>().isLtr ? 0 : 35.0,
                      ),
                      child: CustomText(
                          text: "payment".tr,
                          isActive:
                    ...
                    CustomText(
                        text: "complete".tr,
                        isActive:
                            controller.currentPage == PageState.complete ||
                                pageState == 'complete'),
                  ],
                ),
              ),
