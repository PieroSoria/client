...
import 'package:puntos_client/features/taxi_booking/widgets/cost_variations_dialog.dart';
...
class CarInfo extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    List carFeatureList = [
      {
        'icon': Images.riderSeat,
        'name': '${vehicle.seatingCapacity} ${'seat'.tr}'
      },
      {'icon': Images.petrolIcon, 'name': '${vehicle.fuelType}'},
      {
        'icon': Images.riderKm,
        'name': '${vehicle.engineCapacity}${vehicle.mileageType}'
      },
      {'icon': Images.carHp, 'name': '${vehicle.engineCapacity}cc'},
      {'icon': Images.riderSeat, 'name': 'Auto'},
      {
        'icon': Images.acIcon,
        'name': vehicle.airCondition == 'yes' ? 'ac'.tr : 'non_ac'.tr
      },
    ];
