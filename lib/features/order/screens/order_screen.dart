...
import 'package:puntos_client/features/order/widgets/guest_track_order_input_view_widget.dart';
                      ...
                      child: Column(children: [
                        ResponsiveHelper.isDesktop(context)
                            ? Center(
                                ...
                                child:
                                    Text('my_coupons'.tr, style: robotoMedium),
                              ))
                            : const SizedBox(),
                        Center(
                          child: SizedBox(
