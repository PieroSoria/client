...
import 'package:puntos_client/common/widgets/rating_bar.dart';
import 'package:puntos_client/features/chat/widgets/image_dialog_widget.dart';
import 'package:puntos_client/features/order/widgets/delivery_details_widget.dart';
import 'package:puntos_client/features/payment/widgets/offline_info_edit_dialog_widget.dart';
import 'package:puntos_client/features/order/widgets/order_banner_view_widget.dart';
import 'package:puntos_client/features/order/widgets/order_item_widget.dart';
import 'package:puntos_client/features/parcel/widgets/details_widget.dart';
import 'package:puntos_client/features/review/widgets/review_dialog_widget.dart';
                  ...
                  order.paymentMethod == 'offline_payment' ||
                          (order.paymentMethod == 'partial_payment' &&
                              orderController.trackModel!.offlinePayment !=
                                  null)
                      ? offlineView(
                          context, orderController, controller, ongoing)
                      : Row(children: [
                          Image.asset(
                            order.paymentMethod == 'cash_on_delivery'
                                ? Images.cash
