...
import 'package:puntos_client/features/order/widgets/order_shimmer_widget.dart';
        ...
        builder: (orderController) {
          ...
          return paginatedOrderModel != null
              ? paginatedOrderModel.orders!.isNotEmpty
                                        ...
                                        if (!isRunning) {
                                          ...
                                          Get.toNamed(
                                            ...
                                            arguments: OrderDetailsScreen(
                                              orderId: orderModelUser.id,
                                              orderModel: orderModelUser,
                                            ),
                                          );
                                        }
                                      },
                  ...
                  : NoDataScreen(text: 'no_order_coupon'.tr, showFooter: true)
