...
import 'package:puntos_client/features/checkout/widgets/slot_widget.dart';
                    ...
                    child: Column(mainAxisSize: MainAxisSize.min, children: [
                      ...
                      Flexible(
                        child: ((checkoutController.selectedDateSlot == 0 &&
                            ...
                            ? Center(
                                child: Text(widget.module!.showRestaurantText!
                  ...
                  child: Row(children: [
                    ...
                    Expanded(
                      child: CustomButton(
                        ...
                        onPressed: () {
                          checkoutController
                              .updateTimeSlot(selectedTimeSlotIndex);
                          checkoutController
                              .setPreferenceTimeForView(selectedTimeSlot);
                          Get.back();
                        },
                      ),
                    ),
