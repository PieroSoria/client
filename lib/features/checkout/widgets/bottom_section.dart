...
import 'package:puntos_client/features/checkout/widgets/prescription_image_picker_widget.dart';
...
import 'package:puntos_client/features/checkout/widgets/note_prescription_section.dart';
          ...
          children: [
            storeId == null
                ? Row(
                    mainAxisAlignment: MainAxisAlignment.spaceBetween,
                    children: [
                        Text(module.addOn! ? 'subtotal'.tr : 'price_coupon'.tr,
                            style: robotoMedium),
