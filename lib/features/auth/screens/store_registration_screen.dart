...
import 'package:puntos_client/common/widgets/confirmation_dialog.dart';
import 'package:puntos_client/common/widgets/custom_asset_image_widget.dart';
import 'package:puntos_client/common/widgets/custom_tool_tip_widget.dart';
import 'package:puntos_client/features/auth/widgets/business/base_card_widget.dart';
import 'package:puntos_client/features/auth/widgets/business/web_business_plan_widget.dart';
import 'package:puntos_client/features/auth/widgets/module_view_widget.dart';
import 'package:puntos_client/features/auth/widgets/web_registration_stepper_widget.dart';
import 'package:puntos_client/features/business/widgets/package_card_widget.dart';
...
import 'package:puntos_client/common/models/translation.dart';
...
import 'package:puntos_client/features/auth/widgets/custom_time_picker_widget.dart';
import 'package:puntos_client/features/auth/widgets/pass_view_widget.dart';
import 'package:puntos_client/features/auth/widgets/select_location_view_widget.dart';
...
class _StoreRegistrationScreenState extends State<StoreRegistrationScreen>
                                ...
                                CustomTextField(
                                  ...
                                  validator: (value) =>
                                      ValidateCheck.validateEmptyText(value,
                                          "store_name_field_is_required".tr),
                                ),
                                const SizedBox(
                                    height:
                  ...
                  if (storeRegController.storeStatus == 0.1 ||
                    ...
                    storeRegController.registerStore(StoreBodyModel(
                      ...
                      businessPlan: storeRegController.businessIndex == 0
                          ? 'commission'
                          : 'subscription',
                      packageId: storeRegController
                          .packageModel!
                          .packages![storeRegController.activeSubscriptionIndex]
                          .id!
                          .toString(),
                    ));
                  }
  ...
  void stepOne(bool defaultDataNull, String vat, String minTime, String maxTime,
      bool valid, StoreRegistrationController storeRegController) {
    if (defaultDataNull) {
      _scrollToKey(_storeInfoScrollKey);
    }
    if (vat.isEmpty) {
