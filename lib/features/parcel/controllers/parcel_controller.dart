...
import 'package:puntos_client/features/parcel/domain/models/place_details_model.dart';
import 'package:puntos_client/features/parcel/domain/models/video_content_model.dart';
import 'package:puntos_client/features/parcel/domain/models/why_choose_model.dart';
...
class ParcelController extends GetxController implements GetxService {
  ...
  Future<void> _processAddressAndAction(
      PlaceDetailsModel placeDetails, String? address) async {
  ...
  Future<void> getVideoContentDetails() async {
    _videoContentDetails =
        await parcelServiceInterface.getVideoContentDetails();
    update();
  }
