...
import 'package:puntos_client/features/business/widgets/payment_cart_widget.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return GetBuilder<BusinessController>(builder: (businessController) {
      return PopScope(
        ...
        child: Scaffold(
          appBar:
              isDesktop ? CustomAppBar(title: 'store_registration'.tr) : null,
                    ...
                    child: Column(children: [
                      Container(
                        margin: EdgeInsets.only(
                            top: isDesktop ? Dimensions.paddingSizeSmall : 0),
