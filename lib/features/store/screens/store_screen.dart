...
import 'package:puntos_client/features/category/domain/models/category_model.dart';
...
import 'package:puntos_client/helper/date_converter.dart';
import 'package:puntos_client/helper/price_converter.dart';
...
import 'package:puntos_client/common/widgets/item_widget.dart';
...
import 'package:puntos_client/common/widgets/veg_filter_widget.dart';
import 'package:puntos_client/common/widgets/web_item_view.dart';
import 'package:puntos_client/common/widgets/web_item_widget.dart';
...
import 'package:puntos_client/features/search/widgets/custom_check_box_widget.dart';
import 'package:puntos_client/features/store/widgets/customizable_space_bar_widget.dart';
import 'package:puntos_client/features/store/widgets/store_banner_widget.dart';
import 'package:puntos_client/features/store/widgets/store_description_view_widget.dart';
import 'package:flutter/material.dart';
import 'package:get/get.dart';
import 'package:puntos_client/features/store/widgets/store_details_screen_shimmer_widget.dart';
...
class _StoreScreenState extends State<StoreScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
                  ...
                  ? CustomScrollView(
                      ...
                      slivers: [
                        ResponsiveHelper.isDesktop(context)
                            ? sliverappbarshopdesktop(store)
                            : sliverappbarshopcustom(
                                context, store, storeController),

                        (ResponsiveHelper.isDesktop(context) &&
                                storeController.recommendedItemModel != null &&
                                storeController
                                    .recommendedItemModel!.items!.isNotEmpty)
                            ? slivertoboxrecomenditemmodel(
                        ...
                        ///web view..
                        ResponsiveHelper.isDesktop(context)
                            ? slivertoboxIsDesktop(storeController, context)
                            : const SliverToBoxAdapter(child: SizedBox()),

                        ///mobile view..
                        ResponsiveHelper.isDesktop(context)
                            ? const SliverToBoxAdapter(child: SizedBox())
                            : slivertoboxnotdesktop(
                                context,
                                store,
                                storeController,
                              ),
      ...
      floatingActionButton:
        ...
        final visibility = storeController.showFavButton &&
  ...
  SliverToBoxAdapter slivertoboxIsDesktop(
                            ...
                            return InkWell(
                              onTap: () {
                                storeController.setCategoryIndex(index,
                                    itemSearching: storeController.isSearching);
                              },
                              child: Padding(
                                padding: const EdgeInsets.only(
  ...
  SliverToBoxAdapter slivertoboxrecomenditemmodel(
    BuildContext context,
    StoreController storeController,
  ) {
    return SliverToBoxAdapter(
                      ...
                      return Container(
                        ...
                        child: WebItemWidget(
                          ...
                          item: storeController
                              .recommendedItemModel!.items![index],
                          store: null,
                          index: index,
                          length: null,
                          isCampaign: false,
  ...
  SliverToBoxAdapter slivertoboxnotdesktop(
      BuildContext context, Store? store, StoreController storeController) {
    return SliverToBoxAdapter(
      child: Center(
        child: Container(
          width: Dimensions.webMaxWidth,
              ...
              (!ResponsiveHelper.isDesktop(context) &&
                  ...
                  ? Column(
                      ...
                      children: [
                        ...
                        SizedBox(
                          height:
                              ResponsiveHelper.isDesktop(context) ? 150 : 130,
                          child: ListView.builder(
                            scrollDirection: Axis.horizontal,
  ...
  SliverPersistentHeader sliverPersistentenHeader(
    BuildContext context,
    Store? store,
    StoreController storeController,
  ) {
  ...
  SliverAppBar sliverappbarshopcustom(
    BuildContext context,
    Store? store,
    StoreController storeController,
  ) {
            ...
            return Container(
              ...
              child: Column(
                children: [
                      ...
                      ? Container(
                          ...
                          child: Text(
                            ...
                            style: robotoMedium.copyWith(
                              fontSize: Dimensions.fontSizeSmall,
                              color:
                                  Colors.black.withOpacity(1 - scrollingRate),
                            ),
                            textAlign: TextAlign.center,
                            maxLines: 2,
                            overflow: TextOverflow.ellipsis,
                  ...
                  Container(
                    color:
                        Theme.of(context).cardColor.withOpacity(scrollingRate),
                    ...
                    child: Align(
                      ...
                      child: Container(
                        ...
                        color: Theme.of(context).cardColor.withOpacity(
                              scrollingRate == 0.0 ? 1 : 0,
                            ),
                        padding: EdgeInsets.only(
                          left:
                              Get.find<LocalizationController>().isLtr ? 20 : 0,
                          right:
                              Get.find<LocalizationController>().isLtr ? 0 : 20,
                        ),
                        child: Row(children: [
                          ClipRRect(
                            borderRadius:
  ...
  SliverToBoxAdapter sliverappbarshopdesktop(Store? store) {
    return SliverToBoxAdapter(
      child: Container(
