...
import 'package:puntos_client/features/banner/domain/models/banner_model.dart';
import 'package:puntos_client/features/banner/domain/models/others_banner_model.dart';
import 'package:puntos_client/features/banner/domain/models/promotional_banner_model.dart';
...
class BannerRepository implements BannerRepositoryInterface {
  ...
  Future<PromotionalBanner?> _getPromotionalBannerList() async {
    ...
    if (response.statusCode == 200 && response.body != []) {
      debugPrint("Data recibida : ${response.body}");
