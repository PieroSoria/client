...
import 'package:puntos_client/features/language/widgets/language_bottom_sheet_widget.dart';
...
import 'package:puntos_client/features/menu/widgets/portion_widget.dart';
...
class _MenuScreenState extends State<MenuScreen> {
  ...
  void initState() {
    super.initState();
    _controller = VideoPlayerController.asset(Images.videoLoop)
      ..initialize().then((_) {
        setState(() {
          _controller.play();
                                ...
                                child: Column(
                                  children: [
                                    ...
                                    (Get.find<SplashController>()
                                            ...
                                            1)
                                        ? PortionWidget(
                                            icon: Images.sharedPointsIcon,
                                            title: 'send_and_share_points'.tr,
                                            route: RouteHelper
                                                .getSharedPiontsRoute(),
                                            hideDivider: Get.find<
                                                                SplashController>()
                                                            .configModel!
                                                            .loyaltyPointStatus ==
                                        ...
                                        : const SizedBox(),
                                    PortionWidget(
                                      icon: Images.answerPollsIcon,
                                      title: 'answer_polls'.tr,
                                      route: RouteHelper.getAnswerPollsRoutes(),
                                      hideDivider: Get.find<SplashController>()
                                                      .configModel!
                                                      .loyaltyPointStatus ==
                                                  1 ||
                                    ...
                                    //   title: 'games'.tr,
                                    //   route: RouteHelper.getGamesRoutes(),
                                    //   hideDivider: Get.find<SplashController>()
                                    //                   .configModel!
                                    //                   .loyaltyPointStatus ==
                                    //               1 ||
