...
import 'package:puntos_client/features/brands/screens/brands_product_screen.dart';
import 'package:puntos_client/features/brands/screens/brands_screen.dart';
import 'package:puntos_client/features/business/screens/subscription_payment_screen.dart';
import 'package:puntos_client/features/business/screens/subscription_success_or_failed_screen.dart';
import 'package:puntos_client/features/games/screen/games_screen.dart';
import 'package:puntos_client/features/loyalty/screens/loyalty_screen.dart';
import 'package:puntos_client/features/recieve_points/screens/recieve_points_screen.dart';
import 'package:puntos_client/features/refer_and_earn/screens/refer_and_earn_screen.dart';
import 'package:puntos_client/features/shared_points/screens/shared_points_screen.dart';
import 'package:puntos_client/features/smart_surveys/screens/pages/survey_screen.dart';
import 'package:puntos_client/features/smart_surveys/screens/smart_surveys_screens.dart';
import 'package:puntos_client/features/splash/controllers/splash_controller.dart';
import 'package:puntos_client/features/notification/domain/models/notification_body_model.dart';
import 'package:puntos_client/features/checkout/domain/models/place_order_body_model.dart';
import 'package:puntos_client/features/auth/domain/models/social_log_in_body.dart';
import 'package:puntos_client/features/profile/domain/models/user_information_body.dart';
...
import 'package:puntos_client/features/chat/domain/models/conversation_model.dart';
import 'package:puntos_client/features/order/domain/models/order_model.dart';
import 'package:puntos_client/features/item/domain/models/item_model.dart';
import 'package:puntos_client/features/parcel/domain/models/parcel_category_model.dart';
import 'package:puntos_client/features/store/domain/models/store_model.dart';
import 'package:puntos_client/features/surveys/screen/responde_win_page.dart';
import 'package:puntos_client/features/taxi_booking/models/vehicle_model.dart';
import 'package:puntos_client/features/address/screens/add_address_screen.dart';
import 'package:puntos_client/features/address/screens/address_screen.dart';
import 'package:puntos_client/features/auth/screens/delivery_man_registration_screen.dart';
...
import 'package:puntos_client/features/auth/screens/store_registration_screen.dart';
import 'package:puntos_client/features/category/screens/category_screen.dart';
import 'package:puntos_client/features/location/screens/map_screen.dart';
import 'package:puntos_client/features/store/screens/campaign_screen.dart';
...
import 'package:puntos_client/common/widgets/image_viewer_screen.dart';
import 'package:puntos_client/common/widgets/not_found.dart';
import 'package:puntos_client/features/cart/screens/cart_screen.dart';
import 'package:puntos_client/features/category/screens/category_item_screen.dart';
import 'package:puntos_client/features/chat/screens/chat_screen.dart';
import 'package:puntos_client/features/chat/screens/conversation_screen.dart';
import 'package:puntos_client/features/checkout/screens/checkout_screen.dart';
import 'package:puntos_client/features/payment/screens/offline_payment_screen.dart';
import 'package:puntos_client/features/checkout/screens/order_successful_screen.dart';
import 'package:puntos_client/features/payment/screens/payment_screen.dart';
import 'package:puntos_client/features/payment/screens/payment_webview_screen.dart';
import 'package:puntos_client/features/coupon/screens/coupon_screen.dart';
import 'package:puntos_client/features/dashboard/screens/dashboard_screen.dart';
import 'package:puntos_client/features/favourite/screens/favourite_screen.dart';
import 'package:puntos_client/features/flash_sale/screens/flash_sale_details_screen.dart';
import 'package:puntos_client/features/item/screens/item_campaign_screen.dart';
import 'package:puntos_client/features/item/screens/item_details_screen.dart';
import 'package:puntos_client/features/item/screens/popular_item_screen.dart';
import 'package:puntos_client/features/verification/screens/forget_pass_screen.dart';
import 'package:puntos_client/features/verification/screens/new_pass_screen.dart';
import 'package:puntos_client/features/verification/screens/verification_screen.dart';
import 'package:puntos_client/features/html/screens/html_viewer_screen.dart';
import 'package:puntos_client/features/interest/screens/interest_screen.dart';
import 'package:puntos_client/features/language/screens/language_screen.dart';
import 'package:puntos_client/features/location/screens/access_location_screen.dart';
import 'package:puntos_client/features/location/screens/pick_map_screen.dart';
import 'package:puntos_client/features/notification/screens/notification_screen.dart';
import 'package:puntos_client/features/onboard/screens/onboarding_screen.dart';
import 'package:puntos_client/features/order/screens/guest_track_order_screen.dart';
import 'package:puntos_client/features/order/screens/order_details_screen.dart';
import 'package:puntos_client/features/order/screens/order_screen.dart';
import 'package:puntos_client/features/order/screens/order_tracking_screen.dart';
import 'package:puntos_client/features/order/screens/refund_request_screen.dart';
import 'package:puntos_client/features/parcel/screens/parcel_category_screen.dart';
import 'package:puntos_client/features/parcel/screens/parcel_location_screen.dart';
import 'package:puntos_client/features/parcel/screens/parcel_request_screen.dart';
import 'package:puntos_client/features/profile/screens/profile_screen.dart';
import 'package:puntos_client/features/profile/screens/update_profile_screen.dart';
import 'package:puntos_client/features/store/screens/all_store_screen.dart';
import 'package:puntos_client/features/store/screens/store_item_search_screen.dart';
import 'package:puntos_client/features/store/screens/store_screen.dart';
import 'package:puntos_client/features/review/screens/review_screen.dart';
import 'package:puntos_client/features/search/screens/search_screen.dart';
import 'package:puntos_client/features/splash/screens/splash_screen.dart';
import 'package:puntos_client/features/support/screens/support_screen.dart';
import 'package:puntos_client/features/taxi_booking/booking_checkout_screen/booking_checkout_screen.dart';
import 'package:puntos_client/features/taxi_booking/car_details_screen/car_details_screen.dart';
import 'package:puntos_client/features/taxi_booking/order_status_screen/order_status_screen.dart';
import 'package:puntos_client/features/taxi_booking/select_car_screen.dart';
import 'package:puntos_client/features/taxi_booking/select_map_location/select_map_location.dart';
import 'package:puntos_client/features/taxi_booking/taxi_coupon_screen/taxi_coupon_screen.dart';
import 'package:puntos_client/features/taxi_booking/trip_completed_confermation/trip_completed_confirmation_screen.dart';
import 'package:puntos_client/features/taxi_booking/trip_history/trip_history_screen.dart';
import 'package:puntos_client/features/update/screens/update_screen.dart';
import 'package:flutter/material.dart';
import 'package:get/get.dart';
import 'package:puntos_client/features/wallet/screens/wallet_screen.dart';
...
class RouteHelper {
  ...
  //points
  static const String sharedPoints = '/shared_points';
  static const String recievePoints = '/receive_points';
  static const String answerPolls = '/answer_polls';
  static const String games = '/games';
  static const String survey = '/survey';

  static const String smartSurveys = '/smart_surveys_screen';
  ...
  static String getsurveysList({String? id}) => '$surveys?id=$id';
  ...
  static String getSharedPiontsRoute() => sharedPoints;
  static String getRecievePointsRoutes() => recievePoints;
  static String getAnswerPollsRoutes() => answerPolls;
  static String getGamesRoutes() => games;
  static String getSmartSuveysRoutes() => smartSurveys;
  static String getSurveyRoute() => survey;
  ...
  static List<GetPage> routes = [
    ...
    //Poinst Page
    GetPage(
        name: sharedPoints, page: () => getRoute(const SharedPointsScreen())),

    GetPage(
        name: recievePoints, page: () => getRoute(const RecievePointsScreen())),
    GetPage(name: answerPolls, page: () => getRoute(const AnswerPollsScreen())),
    GetPage(name: games, page: () => getRoute(const GamesScreen())),
    GetPage(
      name: smartSurveys,
      page: () => getRoute(const SmartSurveysScreens()),
    ),
    GetPage(name: survey, page: () => getRoute(const SurveyScreen())),
    //
    GetPage(
      name: notification,
      page: () => getRoute(
